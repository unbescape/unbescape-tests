 ...
 *
 */
public class JavaScriptEscape06Test {
    ...
    public void testXHexaUHexa() throws Exception {
        ...
        final String textXHexaUHexaLevel1 = "\\x0A";
        final String textXHexaUHexaLevel2 = "\\x0A";
        final String textXHexaUHexaLevel3 = "\\x0A";
        final String textXHexaUHexaLevel4 = "\\x0A";
