 ...
 *
 */
public class CssIdentifierEscape24Test {
    ...
    public void testCompact() throws Exception {
        ...
        final String textCompactLevel1 = "\\5C";
        final String textCompactLevel2 = "\\5C";
        final String textCompactLevel3 = "\\5C";
        final String textCompactLevel4 = "\\5C";
    ...
    public void testSixDigit() throws Exception {
        ...
        final String textSixDigitLevel1 = "\\00005C";
        final String textSixDigitLevel2 = "\\00005C";
        final String textSixDigitLevel3 = "\\00005C";
        final String textSixDigitLevel4 = "\\00005C";
    ...
    public CssIdentifierEscape24Test() {
        super();
    }
