 ...
 *
 */
public class CssIdentifierEscape21Test {
    ...
    public void testBESixDigit() throws Exception {
        ...
        final String textBESixDigitLevel1 = "\\000030123456789";
        final String textBESixDigitLevel2 = "\\000030123456789";
        final String textBESixDigitLevel3 = "\\000030123456789";
    ...
    public void testSixDigit() throws Exception {
        ...
        final String textSixDigitLevel1 = "\\000030123456789";
        final String textSixDigitLevel2 = "\\000030123456789";
        final String textSixDigitLevel3 = "\\000030123456789";
    ...
    public CssIdentifierEscape21Test() {
        super();
    }
