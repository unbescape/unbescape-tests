 ...
 *
 */
public class JavaEscapeTestUtil {
    ...
    public static void testEscape1(final String text, final String expected)
            throws IOException {
        testEscape(text, expected, JavaEscapeLevel.LEVEL_1_BASIC_ESCAPE_SET);
    }
    ...
    public static void testEscape2(final String text, final String expected)
            throws IOException {
        testEscape(text, expected, JavaEscapeLevel.LEVEL_2_ALL_NON_ASCII_PLUS_BASIC_ESCAPE_SET);
    }
    ...
    public static void testEscape3(final String text, final String expected)
            throws IOException {
        testEscape(text, expected, JavaEscapeLevel.LEVEL_3_ALL_NON_ALPHANUMERIC);
    }
    ...
    public static void testEscape4(final String text, final String expected)
            throws IOException {
        testEscape(text, expected, JavaEscapeLevel.LEVEL_4_ALL_CHARACTERS);
    }
    ...
    public static void testEscape(final String text, final String expected, final JavaEscapeLevel level)
                                  throws IOException {

        final String resultStr = JavaEscapeUtil.escape(text, level);
        ...
        JavaEscapeUtil.escape(textCharArray, 0, (textCharArray == null ? 0 : textCharArray.length), stringWriter, level);
        ...
        JavaEscapeUtil.escape(textReader2, stringWriter2, level);
        if (textReader2 == null) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            JavaEscapeUtil.escape(array, i, textCharArray.length, stringWriter, level);
            if (textCharArray == null) {
                Assert.assertEquals("", stringWriter.toString());
            } else {
                Assert.assertEquals(expected,stringWriter.toString());
    ...
    public static void testUnescape(final String text, final String expected)
        ...
        final String resultStr = JavaEscapeUtil.unescape(text);
        Assert.assertEquals(expected, resultStr);
        if (resultStr != null && resultStr.equals(text)) {
            Assert.assertSame(text, resultStr);
        }
        ...
        final char[] textCharArray = (text == null? null : text.toCharArray());
        StringWriter stringWriter = new StringWriter();
        JavaEscapeUtil.unescape(textCharArray, 0, (textCharArray == null ? 0 : textCharArray.length), stringWriter);
        if (textCharArray == null) {
            Assert.assertEquals("", stringWriter.toString());
        } else {
            Assert.assertEquals(expected,stringWriter.toString());
        ...
        final Reader textReader2 = (text == null? null : new StringReader(text));
        StringWriter stringWriter2 = new StringWriter();
        JavaEscapeUtil.unescape(textReader2, stringWriter2);
        if (textReader2 == null) {
            Assert.assertEquals("", stringWriter2.toString());
        } else {
            Assert.assertEquals(expected,stringWriter2.toString());
        ...
        for (int i = 0; i < 10; i++) {
            ...
            stringWriter = new StringWriter();
            JavaEscapeUtil.unescape(array, i, textCharArray.length, stringWriter);
            if (textCharArray == null) {
                Assert.assertEquals("", stringWriter.toString());
            } else {
                Assert.assertEquals(expected,stringWriter.toString());
